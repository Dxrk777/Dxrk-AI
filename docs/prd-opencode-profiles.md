...
**R-PROF-23**: El prompt del orchestrator (`orchestrator.md`) DEBE incluir un bloque `<!-- Dxrk-AI:sdd-model-assignments -->` que se inyecta dinámicamente con la tabla de modelos de ESE perfil específico.
...
```bash
Dxrk-AI sync --profile cheap:anthropic/claude-haiku-3.5-20241022
```
