...
```
~/.config/Dxrk-AI/custom-agents.json
```
...
graph TB
    ...
    subgraph STORAGE["Storage"]
        ...
        REGISTRY_FILE["~/.config/Dxrk-AI/custom-agents.json"]
...
| R-AB-08 | The Agent Builder MUST maintain a local registry of custom agents at `~/.config/Dxrk-AI/custom-agents.json` | P0 |
