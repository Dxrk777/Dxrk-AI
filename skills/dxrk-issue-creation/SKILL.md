...
- Open any GitHub issue on the [Dxrk777/gentle-ai](https://github.com/Dxrk777/gentle-ai) repository
...
4. **Questions go to Discussions** — use [GitHub Discussions](https://github.com/Dxrk777/gentle-ai/discussions), NOT issues, for questions and general conversation.
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/Dxrk777/gentle-ai/issues
...
```
https://github.com/Dxrk777/gentle-ai/issues/new?template=bug_report.yml
```
...
Or open the web form directly:
```
https://github.com/Dxrk777/gentle-ai/issues/new?template=feature_request.yml
```
...
│         https://github.com/Dxrk777/gentle-ai/discussions
...
```bash
# Search open issues
gh issue list --repo Dxrk777/gentle-ai --state open --search "your keywords"

# Search all issues including closed
gh issue list --repo Dxrk777/gentle-ai --state all --search "your keywords"
```
...
```bash
gh issue view <number> --repo Dxrk777/gentle-ai
```
