...
ALWAYS use these exact colors. Source: `dxrk-kanagawa-blur/lua/dxrk_kanagawa_blur/variant.lua`
...
- **Color source**: `dxrk-kanagawa-blur/lua/dxrk_kanagawa_blur/variant.lua`
