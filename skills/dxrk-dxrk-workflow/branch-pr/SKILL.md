...
- Open a pull request on [Dxrk-AI/dxrk](https://github.com/Dxrk-AI/dxrk)
...
1. Confirm the issue has status:approved
   gh issue view <N> --repo Dxrk-AI/dxrk
...
```bash
gh pr checks --repo Dxrk-AI/dxrk <PR-number>
gh pr view --repo Dxrk-AI/dxrk <PR-number>
```

### Add a Label

```bash
gh pr edit <PR-number> --repo Dxrk-AI/dxrk --add-label "type:bug"
```
