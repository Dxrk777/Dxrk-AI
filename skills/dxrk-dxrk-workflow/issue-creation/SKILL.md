...
- Open any GitHub issue on the [Dxrk-AI/dxrk](https://github.com/Dxrk-AI/dxrk) repository
...
4. **Questions go to Discussions** — use [GitHub Discussions](https://github.com/Dxrk-AI/dxrk/discussions), NOT issues, for questions and general conversation.
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/Dxrk-AI/dxrk/issues
...
```
https://github.com/Dxrk-AI/dxrk/issues/new?template=bug_report.yml
```
...
Or open the web form directly:
```
https://github.com/Dxrk-AI/dxrk/issues/new?template=feature_request.yml
```
...
│         https://github.com/Dxrk-AI/dxrk/discussions
...
```bash
# Search open issues
gh issue list --repo Dxrk-AI/dxrk --state open --search "your keywords"

# Search all issues including closed
gh issue list --repo Dxrk-AI/dxrk --state all --search "your keywords"
```
...
```bash
gh issue view <number> --repo Dxrk-AI/dxrk
```
