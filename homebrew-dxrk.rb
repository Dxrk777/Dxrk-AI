...
class Dxrk < Formula
  ...
  on_macos do
    on_intel do
      url 'https://github.com/Dxrk777/Dxrk-Hex/releases/download/v1.2.0/dxrk_1.1.0_darwin_amd64.tar.gz'
      sha256 '693f15aa41549406806b7d8fece345bf13e12b2761a4fce01e037912f082982f'
    end
    on_arm do
      url 'https://github.com/Dxrk777/Dxrk-Hex/releases/download/v1.2.0/dxrk_1.1.0_darwin_arm64.tar.gz'
  ...
  on_linux do
    on_intel do
      url 'https://github.com/Dxrk777/Dxrk-Hex/releases/download/v1.2.0/dxrk_1.1.0_linux_amd64.tar.gz'
      sha256 '6b2ee33f2f358c2526cce4104e4a6047e9972b9621b4fb4d6d3849e9c588e6a2'
    end
    on_arm do
      url 'https://github.com/Dxrk777/Dxrk-Hex/releases/download/v1.2.0/dxrk_1.1.0_linux_arm64.tar.gz'
