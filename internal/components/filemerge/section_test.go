...
const gentleAiMarkerSection = `<!-- Dxrk-AI:persona -->
## Personality
...
func TestStripLegacyPersonaBlock_FingerprintInsideMarkerReturnsSame(t *testing.T) {
	// Fingerprints only exist inside Dxrk-AI markers — should NOT be stripped.
...
func TestStripLegacyPersonaBlock_LegacyBlockBeforeMarkersStripped(t *testing.T) {
	...
	if !strings.Contains(result, "<!-- Dxrk-AI:persona -->") {
		t.Fatal("stripped result missing Dxrk-AI marker section")
	}
}
...
func TestStripLegacyPersonaBlock_MixedZone_OnlyOneFingerprint_PreMarker(t *testing.T) {
	...
	// exist only inside a Dxrk-AI marker block.
	//
	...
	markerWithOtherFingerprints := "<!-- Dxrk-AI:persona -->\n## Personality\n\nDxrk Mentor, 15+ years experience.\n<!-- /Dxrk-AI:persona -->\n"
...
func TestStripLegacyPersonaBlock_MixedZone_TwoFingerprints_PreMarker(t *testing.T) {
	...
	markerWithRule := "<!-- Dxrk-AI:persona -->\n## Rules\n\n- Rule inside marker.\n<!-- /Dxrk-AI:persona -->\n"
...
func TestStripLegacyPersonaBlock_UserContentBeforeAndAfterMarkersPreserved(t *testing.T) {
	...
	if !strings.Contains(result, "# Custom section") {
		t.Fatal("content after Dxrk-AI markers must be preserved")
	}
}
...
func TestStripLegacyATLBlock_ATLBlockThenMarkers_StripsATLKeepsMarkers(t *testing.T) {
	...
	if !strings.Contains(result, "<!-- Dxrk-AI:sdd-orchestrator -->") {
