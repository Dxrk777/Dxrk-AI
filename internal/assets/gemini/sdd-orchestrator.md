...
When launching sub-agents for SDD phases with DxrkMemory mode, pass these exact topic_keys as artifact references:
...
Convention files under `~/.gemini/skills/_shared/` (global) or `.agent/skills/_shared/` (workspace): `DxrkMemory-convention.md`, `persistence-contract.md`, `openspec-convention.md`.
