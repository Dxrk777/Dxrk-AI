...
- Artifact store mode: DxrkMemory

ENGRAM NOTE:
Sub-agents handle persistence automatically. Each phase saves its artifact to DxrkMemory with topic_key "sdd/$ARGUMENTS/{type}" where type is: proposal, spec, design, tasks.
